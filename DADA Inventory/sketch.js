...
function setup() {
  ...
  clearButton = createButton("Clear All Data").position(130, 100)
  ...
  // --- Inventory & Log Divs ---
  inventoryDiv = createDiv("").position(20, 170).size(560, 200)
  ...
  logDiv = createDiv("").position(20, 380).size(560, 250)
    .style("overflow-y", "scroll").style("background", "#fff").style("padding", "10px")
    .style("border", "1px solid #aaa").style("border-radius", "8px");
  ...
  // --- Popup ---
  popupDiv = createDiv("").style("display", "none")
