...
fillLevel += 0.001;
fillLevel = constrain(fillLevel, 0, 1);

Tone.Transport.bpm.value = map(fillLevel, 0, 1, 80, 160);
rev.decay = map(fillLevel, 0, 1, 1, 6);
filt.frequency.value = map(fillLevel, 0, 1, 500, 3000);
